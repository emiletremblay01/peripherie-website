...
const buttonVariants = cva(
  "inline-flex disabled:cursor-not-allowed disabled:opacity-50 items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-gray-950 dark:focus-visible:ring-gray-300",
  {
    variants: {
      variant: {
        peripherie:
          "justify-between border rounded-full border-black text-base  hover:font-g2ciao   hover:bg-gray-50",
        default:
